...
require_once('form/initialize.php');


if (isset($_POST['submit'])) {
  $mail_data = [];
  $mail_data['name'] = $_POST['name'] ?? '';
  $mail_data['email'] = $_POST['email'] ?? '';
  $mail_data['subject'] = $_POST['subject'] ?? '';
  $mail_data['message'] = $_POST['message'] ?? '';

  $result = validate_mail_data($mail_data);

  if ($result === true) {
    process_form($mail_data);
    $_SESSION['message'] = 'Vasa poruka je uspesno poslata';
            ...
            <form name="contact" method="post" action="kontakt.php">
              <div class="row">
                <div class="col form-group">
                  <input type="text" name="name" value="<?php echo $mail_data['name']; ?>" class="form-control" placeholder="Vaše ime">
                </div>
                <div class="col form-group">
                  <input type="email" class="form-control" name="email" value="<?php echo $mail_data['email']; ?>" placeholder="Vaš Email">
                </div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="subject" value="<?php echo $mail_data['subject']; ?>" placeholder="Predmet Vaše poruke">
              </div>
              <div class="form-group">
                <textarea class="form-control" name="message" rows="5" value="<?php echo $mail_data['message']; ?>" placeholder="Vaša poruka"></textarea>
              </div>
